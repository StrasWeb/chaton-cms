...
if((isset($article->id)||isset($page->id))) {
  ...
  $this->article->firstChild->firstChild->addElement("a",null,array(),true)->addElement("img",null,array("src"=>"plugins/".$this->dir."/Adobe_PDF_Icon.svg","alt"=>"PDF","class"=>"toPDF","height"=>30,"title"=>_("Export to PDF")));
  if(isset($article)) {
