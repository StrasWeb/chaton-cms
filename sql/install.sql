...
CREATE TABLE IF NOT EXISTS `%s` (  `title` varchar(255) NOT NULL,  `id` int(11) NOT NULL AUTO_INCREMENT,  `date` date NOT NULL, `cat` int(11) NOT NULL,  `content` longtext NOT NULL,  `lang` char(2) NOT NULL DEFAULT 'en',  KEY `id` (`id`))   DEFAULT CHARSET=utf8;
